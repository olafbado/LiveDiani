...
export default function ManageStack() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="ManageDashboard" component={ManageDashboardScreen} options={{ title: 'Manage' }} />
...
<Stack.Screen name="CategoryForm" component={CategoryFormScreen} options={{ title: 'Category Form' }} />
      ...
      <Stack.Screen name="ManageTags" component={ManageTagsScreen} options={{ title: 'Manage Tags' }} />
      <Stack.Screen name="TagForm" component={TagFormScreen} options={{ title: 'Tag Form' }} />

      <Stack.Screen name="ManageLocations" component={ManageLocationsScreen} options={{ title: 'Locations' }} />
      <Stack.Screen name="LocationForm" component={LocationFormScreen} options={{ title: 'Location Form' }} />
      
      <Stack.Screen name="ManageEvents" component={ManageEventsScreen} options={{ title: 'Events' }} />
